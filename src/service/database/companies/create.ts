...
export const createCompany = async (input: {
  ...
  try {
    ...
    const rows = await sqlClient`
      INSERT INTO companies (id, name, pattern, domain, category_key, segment_key, user_id)
      VALUES (${id}, ${input.name.trim()}, ${pattern}, ${domain}, ${category_key}, ${segment_key}, ${auth.data.user.id})
